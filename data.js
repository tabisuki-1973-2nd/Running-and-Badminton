...
window.trainingData = {
  ...
  weekSchedule: [
    ...
    { date:"5/10", fullDate:"2026-05-10", day:"日", done:false, menu:"休養",                                         actual:"",
      training: ["プランク　30〜45秒 × ２セット", "バードドッグ（左右）　各10回 × ２セット", "ヒップリフト　15回 × ２セット", "カーフレイズ　20回 × ２セット", "腸腰筋ストレッチ（左右）　30秒"] },
    // ── 来週 5/11(月) 〜 5/17(日) ──
    { date:"5/11", fullDate:"2026-05-11", day:"月", done:false, menu:"ジョグ5〜7km",                                  actual:"",
      training: ["プランク　30〜45秒 × ２セット", "バードドッグ（左右）　各10回 × ２セット", "ヒップリフト　15回 × ２セット", "カーフレイズ　20回 × ２セット", "腸腰筋ストレッチ（左右）　30秒"] },
    { date:"5/12", fullDate:"2026-05-12", day:"火", done:false, menu:"テンポ走7km（5:30〜6:00/km）",                  actual:"",
      training: ["プランク　30〜45秒 × ２セット", "バードドッグ（左右）　各10回 × ２セット", "ヒップリフト　15回 × ２セット", "カーフレイズ　20回 × ２セット", "腸腰筋ストレッチ（左右）　30秒"] },
    { date:"5/13", fullDate:"2026-05-13", day:"水", done:false, menu:"ジョグ5〜7km",                                  actual:"",
      training: ["プランク　30〜45秒 × ２セット", "バードドッグ（左右）　各10回 × ２セット", "ヒップリフト　15回 × ２セット", "カーフレイズ　20回 × ２セット", "腸腰筋ストレッチ（左右）　30秒"] },
