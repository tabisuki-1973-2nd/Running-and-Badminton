...
window.trainingData = {
  ...
  weekSchedule: [
    ...
    { date:"5/2",  fullDate:"2026-05-02", day:"土", done:true,  menu:"テンポ走7km（5:30〜6:00/km）",                  actual:"8km　ペース5:36　心拍147/158　負荷148",
    ...
    { date:"5/3",  fullDate:"2026-05-03", day:"日", done:true,  menu:"ジョグ7〜10km",                                actual:"10km　ペース6:57　心拍117/130　負荷74",
      training: ["プランク　30〜45秒 × ２セット", "バードドッグ（左右）　各10回 × ２セット", "ヒップリフト　15回 × ２セット", "カーフレイズ　20回 × ２セット", "腸腰筋ストレッチ（左右）　30秒"] },
    // ── 来週 5/4(月) 〜 5/10(日) ──
